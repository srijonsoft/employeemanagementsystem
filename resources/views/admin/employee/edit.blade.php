      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
			<h1><i class="fa fa-edit"></i>Edit Employee {{ $employee->id }}</h1>
			<hr />
			{!! Form::model($employee, [
				'method' => 'PATCH',
			  ...
			  {!! Form::open(['url' => '/admin/employee', 'class' => 'form-horizontal', 'files' => true, 'method' => 'post', 'accept-charset' => 'utf-8']) !!}
				...
				<div class="col-md-6">
					...
					{!! Form::label('emp_image', 'Image', ['class' => 'col-sm-4 control-label']) !!}
					<div class="col-sm-6">
						<div class="fileinput fileinput-new" data-provides="fileinput">
							<div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
								<img src="{{ url('public/images/upload/emp_img/'.$employee->emp_image) }}" class="img-thumbnail" alt="...">
							</div>
				...
				<div class="col-sm-6">
					<div class="fileinput fileinput-new" data-provides="fileinput">
						<div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
							<img src="{{ url('public/images/upload/join_letter/'.$employee->letter_file) }}" class="img-thumbnail" alt="...">
						</div>
						<div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px"></div>
						<div>
							<span class="btn btn-white btn-file">
